...
import { getHeelsDataByTypes, getHijabDataByTypes, getTasDataByTypes } from '../../../redux/action';
...
const NewSection = () => {
  ...
  const {newTas} = useSelector(state => state.categoryReducer);

  useEffect(() => {
    dispatch(getTasDataByTypes('New Collection'));
  }, []);
...
const PopularSection = () => {
  ...
  useEffect(() => {
    dispatch(getTasDataByTypes('Popular'));
  }, []);
  return (
    <View style={{paddingTop: 8, paddingHorizontal: 24}}>
...
const RecommendedSection = () => {
  ...
  useEffect(() => {
    dispatch(getTasDataByTypes('Recommended'));
  }, []);
  return (
    <View style={{paddingTop: 8, paddingHorizontal: 24}}>
